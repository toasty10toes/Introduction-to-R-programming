...
```
Word of caution: Some people don't like when scripts change the CWD because it might mess with other projects that they have open. Or change the CWD to a local path that isn't reproducible on someone elses computer. 
...
If you are working in an R project you will only need to include the file path starting from the project folder. For example if you have a csv stored in a Data folder in your project space you would read it in with:
